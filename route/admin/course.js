...
route.get('/course/list/admin',adminValidate,(req,res)=>{
    ...
    Courses.find({ admin:user}).then((course)=>{
        ...
        res.render('admin/a-course',{course:course,user:req.user,title:"Admin",description:"",error:req.flash('error'),info:req.flash('info'),search:"scourse"})
    }).catch((err)=>{
        console.log(err)
...
try {
    res.render('admin/a-page', {course: course,user:req.user,pages: course.articles,error:req.flash('error'),info:req.flash('info'),search:"scourse"})   
} catch (error) {
...
route.get('/admin/create/:id/',adminValidate,(req,res)=>{
    ...
    res.render('admin/a-create',{id: courseId,data:"",user:req.user,error:req.flash('error'),info:req.flash('info'),search:"scourse"})
})
...
res.render('admin/a-edit',{page:article,user:req.user,cid:cid,title:"Admin",description:"",dummy:'',search:"scourse"})
})
